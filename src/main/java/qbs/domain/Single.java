...
public class Single implements Serializable {
	...
	public Single(Long id, String academyName, String subjectName, String chapterName, String dif_coefficient,
			String body, String optionA, String optionB, String optionC, String optionD, String answer) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Single [" + (id != null ? "id=" + id + ", " : "")
				...
				+ (optionD != null ? "optionD=" + optionD + ", " : "") + (answer != null ? "answer=" + answer : "")
				+ "]";
	}
